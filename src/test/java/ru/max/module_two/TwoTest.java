...
import ru.max.module_two.fragments.StatusFragment;
...
public class TwoTest {
    ...
    public void test() throws IOException, InterruptedException, TimeoutException {
        testPlan(
                ...
                getThreadGroup("THREAD_GROUP_TWO", profileParameters.get("THREAD_GROUP_TWO"), commonTestParameters.getDebugEnable())
                        .children(
                                StatusFragment.get(),
